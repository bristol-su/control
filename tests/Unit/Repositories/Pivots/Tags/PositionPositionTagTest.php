...
class PositionPositionTagTest extends TestCase
{
    ...
    public function it_gets_all_tags_through_a_position(){
        ...
        $positionTagsForPosition = PositionTag::factory()->count(10)->create();
        $positionTagsNotForPosition = PositionTag::factory()->count(10)->create();
    ...
    public function it_gets_all_positions_tagged_with_a_tag(){
        ...
        $positionsForPositionTag = Position::factory()->count(10)->create();
        $positionsNotForPositionTag = Position::factory()->count(10)->create();
