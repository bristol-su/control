...
class GroupGroupTagTest extends TestCase
{
    ...
    public function it_gets_all_tags_through_a_group(){
        ...
        $groupTagsForGroup = factory(GroupTag::class, 10)->create();
        $groupTagsNotForGroup = factory(GroupTag::class, 10)->create();
    ...
    public function it_gets_all_groups_tagged_with_a_tag(){
        ...
        $groupsForGroupTag = factory(Group::class, 10)->create();
        $groupsNotForGroupTag = factory(Group::class, 10)->create();
