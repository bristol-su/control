...
class UserUserTagTest extends TestCase
{
    ...
    public function it_gets_all_tags_through_a_user(){
        ...
        $userTagsForUser = UserTag::factory()->count(10)->create();
        $userTagsNotForUser = UserTag::factory()->count(10)->create();
    ...
    public function it_gets_all_users_tagged_with_a_tag(){
        ...
        $usersForUserTag = User::factory()->count(10)->create();
        $usersNotForUserTag = User::factory()->count(10)->create();
